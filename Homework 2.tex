...
And we will ask you to visualize them in the next question anyway.
  ...
  \begin{figure}[h!]
  	\centering
  	\includegraphics[width=1.0\textwidth]{q51.png}  
  	% reference folder/figure.pdf here and adjust width
  	\captionsetup{labelformat=empty}
  	\caption{}
  	\label{fig:my_label}
...
We can see it easily that if x2 is greater than 0.201829 then it has the label 0 otherwise it has the label 1
  ...
  \begin{figure}[H]
  	\centering
  	\includegraphics[width=1.0\textwidth]{q52.png}  
  	% reference folder/figure.pdf here and adjust width
  	\captionsetup{labelformat=empty}
  	\caption{}
  	\label{fig:my_label}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{q611.png}  
	% reference folder/figure.pdf here and adjust width
	\captionsetup{labelformat=empty}
	\caption{}
	\label{fig:my_label}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{q622.png}  
	% reference folder/figure.pdf here and adjust width
	\captionsetup{labelformat=empty}
	\caption{}
	\label{fig:my_label}
...
I think for D1 it was trying to model y= -0.2 essentially and hence it was able to create a simple decesion tree but d2 had a linear relationship and decesiopn tree work on better on non linear data hence we can see the difference in the decesion boundaries and the size because it was trying to overfit a linear relation ship.
...
\begin{figure}[H]
	...
	% reference folder/figure.pdf here and ajust width
	\captionsetup{labelformat=empty}
	\caption{}
	\label{fig:my_label}
\end{figure}
